...
public class NaturallyTrimmed /*? if fabric {*/implements ModInitializer/*?}*/ {
	...
	public static final LootItemFunctionType<TrimRandomlyFunction> TRIM_RANDOMLY_FUNCTION = Registry.register(
			BuiltInRegistries.LOOT_FUNCTION_TYPE,
			ResourceLocation.tryBuild(MOD_ID, "trim_randomly_function"),
			new LootItemFunctionType<>(TrimRandomlyFunction.CODEC));
	...
	public void onInitialize() {
		...
		LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> tableBuilder.modifyPools(poolBuilder -> poolBuilder.apply(TrimRandomlyFunction.randomTrim())));
	}
